...
public class TeacherEditableGradeView extends JFrame {
    JPanel tUpdatePanel;
    JButton saveBtn;

    public TeacherEditableGradeView() {
    ...
    public void teacherUpdateGrade() {
        ...
        tUpdatePanel.setBounds(0, 0, 600, 800);
        tUpdatePanel.setLayout(null);
        add(tUpdatePanel);
        ...
        tUpdatePanel.add(saveBtn);
    }

    public static void main(String[] args) {
        TeacherEditableGradeView teacherEditableGradeView = new TeacherEditableGradeView();
    }
}